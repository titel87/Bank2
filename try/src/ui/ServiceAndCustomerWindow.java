            ...
            public void handle(ActionEvent event) {
                if(isBankerSelected == true && isATMSelected == true){
                	...
                	if(isBankerSelected == true){
                        ...
                        try {
							bankeActions.start(new Stage(), customersList.getSelectionModel().getSelectedItem(), bankersList.getSelectionModel().getSelectedItem(), null);
						} catch (Exception e) {
							e.printStackTrace();
						}
                		...
                		BankActionsWindow bankeActions = new BankActionsWindow();
                        try {
							bankeActions.start(new Stage(), customersList.getSelectionModel().getSelectedItem(), null, ATMsList.getSelectionModel().getSelectedItem());
						} catch (Exception e) {
							e.printStackTrace();
						}
                	}
